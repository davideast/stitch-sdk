...
| 21  | `v1/21-docs-audit`             | §4.4 (Stage 9): README migrated to 1.0 surface (Generation, content vs URL accessors, options objects, /tools subpath); stitch-sdk-development purged of phantom fieldMapping/idField + Generation examples; usage + domain-design skills already migrated in-branch (13/14/08). Examples updated across branches 13/14. | green   |
