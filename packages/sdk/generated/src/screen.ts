...
Generated: 2026-06-10T03:32:04.007Z
 */
...
export class Screen {
     ...
     * Tool: edit_screens
     */
    async edit(prompt: string, options?: { deviceType?: "DEVICE_TYPE_UNSPECIFIED" | "MOBILE" | "DESKTOP" | "TABLET" | "AGNOSTIC"; modelId?: "MODEL_ID_UNSPECIFIED" | "GEMINI_3_PRO" | "GEMINI_3_FLASH" | "GEMINI_3_1_PRO" }): Promise<Screen> {
        try {
     ...
     */
    async variants(prompt: string, variantOptions: VariantOptions, options?: { deviceType?: "DEVICE_TYPE_UNSPECIFIED" | "MOBILE" | "DESKTOP" | "TABLET" | "AGNOSTIC"; modelId?: "MODEL_ID_UNSPECIFIED" | "GEMINI_3_PRO" | "GEMINI_3_FLASH" | "GEMINI_3_1_PRO" }): Promise<Screen[]> {
        try {
